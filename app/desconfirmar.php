...
if($numeroLinhas == 1){
    $confirm = 0;
    $desconfirmar = $repositorio->DesconfirmarPresenca($confirm,$nome_convidado,$doc_convidado);
    $_SESSION['mensagem'] = "Presença do convidado $nome_convidado DESCONFIRMADA com sucesso";
    ...
    header('Location: formulario_desconfirm.php');
}
